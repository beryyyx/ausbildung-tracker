...
export const SEARCH_LABELS = {
  ...
  radius: "Радиус",
  startFrom: "Старт не раньше",
  submit: "Искать",
  searchingAround: "Поиск вокруг",
  sourceFound: "Источник нашёл",
  truncated: "показаны первые",
  matchingFrom: "подходят по старту с",
  withDate: "с датой старта",
  withoutDate: "без даты",
  undated: "дата не указана",
  noneAfterDate: "По дате старта ничего не подходит",
  allStartEarlier: "но старт у всех раньше",
  moveDateHint: "Сдвиньте дату назад или очистите поле, чтобы выключить фильтр.",
  page: "Страница",
  previous: "Назад",
  next: "Дальше",
